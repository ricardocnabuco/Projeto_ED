...
# Criar uma instância da fila de voos
fila_de_voos_instancia = fila_de_voos()

# Adicionar alguns voos à fila
fila_de_voos_instancia.insercao("08:30", "V001", "A1", "Cidade A")
fila_de_voos_instancia.insercao("09:45", "V002", "B2", "Cidade B")
fila_de_voos_instancia.insercao("10:15", "V003", "C3", "Cidade C")

# Imprimir a tabela de voos antes da ordenação
print("Tabela de Voos (antes da ordenação):")
fila_de_voos_instancia.travessia()

# Ordenar os voos
fila_de_voos_instancia.insertion_sort()

# Imprimir a tabela de voos após a ordenação
print("\nTabela de Voos (após a ordenação):")
fila_de_voos_instancia.travessia()

# Remover um voo da fila
codigo_voo_remover = "V002"
fila_de_voos_instancia.remocao(codigo_voo_remover)

# Imprimir a tabela de voos após a remoção
print("\nTabela de Voos (após a remoção):")
fila_de_voos_instancia.travessia()

# Buscar um voo na fila
codigo_voo_buscar = "V001"
horario_voo_buscar = "08:30"
print(f"\nBusca do Voo {codigo_voo_buscar} no horário {horario_voo_buscar}:")
fila_de_voos_instancia.busca_binaria(codigo_voo_buscar, horario_voo_buscar)
